   ...
   // public GameObject spawnObject1;
    ...
    public void Prefs()
    {
        ...
        if (prefs == 0)
        {
            ...
            prefs = PlayerPrefs.GetFloat("prefs", prefs) + 1;
            PlayerPrefs.SetFloat("prefs", prefs);
    ...
    private void Start()
    {
        ...
        prefs = PlayerPrefs.GetFloat("prefs", prefs);    

        if (score > Mathf.Round(PlayerPrefs.GetFloat("highscore", score)))
        {
